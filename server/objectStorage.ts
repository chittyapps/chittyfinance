...
export class ObjectStorageService {
  ...
  async getDocumentUploadURL(): Promise<string> {
    ...
    const fullPath = `${privateObjectDir}/documents/${documentId}`;
  ...
  // Gets the document file from the document URL.
  async getDocumentFile(documentUrl: string): Promise<File> {
  ...
  // Downloads document content as text for AI processing
  async getDocumentText(documentUrl: string): Promise<string> {
    try {
      const file = await this.getDocumentFile(documentUrl);
