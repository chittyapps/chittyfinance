...
export const transactions = pgTable('transactions', {
  ...
  payee: text('payee'),
  propertyId: uuid('property_id').references(() => properties.id, { onDelete: 'set null' }), // Links to properties table
  unitId: uuid('unit_id').references(() => units.id, { onDelete: 'set null' }), // Links to units table
